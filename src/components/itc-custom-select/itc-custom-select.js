export default class ItcCustomSelect {
    ...
    static MODAL_BG = 'itc-select__modal-bg';
    static BTN_CLOSE = 'itc-select__close';
    ...
    static hideOpenSelect() {
        document.addEventListener('click', (e) => {
            // Расширил варианты закрытия
            if (!e.target.closest(`.${this.EL}`) || e.target.closest(`.${this.MODAL_BG}`) || e.target.closest(`.${this.BTN_CLOSE}`)) {
